    ...
    <div className="flex items-center gap-4 ">
      <div className="social-button">
        <button className="relative w-8 h-8 rounded-full group">
          ...
          <div className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-zin-300 rounded-full">
            <a
            ...
            >
              ...
              >
                <path
                  className="group-hover:fill-[#fff] fill-zinc-400 duration-300"
